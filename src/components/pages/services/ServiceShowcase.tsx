          ...
          >
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 p-6 md:p-8 items-center">
              <div className="md:col-span-2 flex md:justify-center">
                <span className="text-5xl md:text-6xl font-black tracking-tight text-[#6748FE]/80 group-hover:text-[#6748FE] transition-colors duration-300">
                  {service.number}
                </span>
              </div>

              <div className="md:col-span-6">
                <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-3 md:mb-4 tracking-wide sm:tracking-normal">
                  {service.title}
                </h3>
