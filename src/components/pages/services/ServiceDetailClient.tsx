...
serviceSubtitle="For Startups, Innovators & Early-Stage Founders";
  ...
  // Split title: AI Strategic (top, colored #6748FE), rest (bottom, white)
...
shadow-[0_0_25px_rgba(103,72,254,0.5)]
...
return (
  ...
  >
    ...
    <div className="absolute top-0 left-0 right-0 flex justify-center pointer-events-none">
      ...
      >
        <path
          d="M0 28 Q150 -6 300 28"
          stroke="url(#arcGrad)"
          strokeWidth="1.2"
          fill="none"
        />
        <defs>
          <linearGradient id="arcGrad" x1="0" y1="0" x2="300" y2="0" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="rgba(103,72,254,0)" />
            <stop offset="50%" stopColor="rgba(155,133,255,0.95)" />
            <stop offset="100%" stopColor="rgba(103,72,254,0)" />
          </linearGradient>
        </defs>
      </svg>
    </div>
    ...
    <div className="relative z-10 flex flex-col flex-1 p-6 md:p-7 pt-9">
      ...
      {proc.services && (
        <div className="flex-1">
          <span className="block mb-2.5 text-xs uppercase tracking-[0.2em] font-bold" style={{ color: "#6748FE" }}>
            Services
          </span>
              ...
              <li key={idx} className="flex items-center gap-2 text-sm text-white">
                ...
                <span className="flex-shrink-0 flex items-center justify-center w-4 h-4 mt-0.5">
                  <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <path d="M2 1.5 L8 5 L2 8.5 Z" fill="#6748FE" />
                  </svg>
                </span>
                <span>{item}</span>
              </li>
