...
function CustomGlowingIcon({
  ...
  return (
    <div className="relative flex items-center justify-center w-12 h-12">
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-400/30 to-purple-500/30 border border-white/20 blur-[1px]" />
...
export default function ServiceDetailClient({
  ...
  const { services = [] } =
    (servicesData as { services?: ServiceItem[] }) || {};
  ...
  const hasAiStrategic = fullTitle
    .toLowerCase()
    .includes("ai strategic");

  const subTitleText = hasAiStrategic
    ? fullTitle
        .substring(
          fullTitle.toLowerCase().indexOf("ai strategic") +
            "ai strategic".length
        )
        .trim()
    : fullTitle;

  const cleanGlassCardStyle = {
    ...GLASS_CARD_STYLE,
    boxShadow: "none",
  };

  return (
    <div className="relative min-h-screen bg-[#020611] text-white overflow-hidden">
      {/* BACKGROUND WITH SIDES BLUE & CENTER DARK VIGNETTE EFFECT */}
      <div className="fixed inset-0 z-0 bg-[#020611]">
        {/* Strong vibrant blue glows on the left and right sides */}
        <div className="absolute top-1/4 left-[-10%] w-[700px] h-[700px] bg-blue-600/35 rounded-full blur-[150px] pointer-events-none" />
        <div className="absolute bottom-1/4 right-[-10%] w-[700px] h-[700px] bg-indigo-600/35 rounded-full blur-[150px] pointer-events-none" />
        <div className="absolute top-1/2 left-[-5%] w-[500px] h-[500px] bg-cyan-500/25 rounded-full blur-[130px] pointer-events-none" />
        <div className="absolute top-1/3 right-[-5%] w-[500px] h-[500px] bg-blue-500/25 rounded-full blur-[130px] pointer-events-none" />

        {/* Center Dark Deep Vignette Overlay */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(2,6,17,0.85)_65%,#020611_100%)] pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 md:pt-44 pb-20">
        ...
        <div className="flex flex-col items-center text-center mb-6 md:mb-14">
          ...
          <div className="flex items-center justify-center gap-4 w-full max-w-3xl mb-4 md:mb-10">
            ...
            <span className="px-6 py-2 rounded-full text-xs md:text-sm uppercase tracking-widest font-semibold text-center text-white border border-[#6748FE]/30 bg-[#020611]/80 backdrop-blur-md">
              {serviceSubtitle}
            </span>
          ...
          <div className="w-full max-w-4xl mx-auto mb-4 md:mb-16">
            ...
            <div className="text-left px-2 md:hidden">
              <p className="text-sm text-slate-300 leading-relaxed">
                <span className="font-bold text-[#6748FE] mr-1">
                  {service.purpose?.title || "Purpose"}:
                </span>
            ...
            {/* Desktop View */}
            <div
              className="hidden md:block relative overflow-hidden w-full p-7 rounded-[2rem] border border-[#6748FE]/30 backdrop-blur-xl bg-[#030917]/60"
              style={cleanGlassCardStyle}
            >
              {/* Marble texture inside card with smooth black-blue gradient blend */}
              <div
                ...
                style={{
                  background: `
                    ...
                    linear-gradient(180deg, #020611 0%, #030917 50%, #07122c 100%)
                  `,
                }}
              />
              <img
          ...
          {service.process?.map((proc: ProcessStep, index: number) => {
            ...
            return (
              <motion.div
                ...
                variants={fadeUp}
                className={`relative overflow-hidden flex flex-col rounded-[2rem] p-6 md:p-7 pt-9 transition-all duration-500 border border-[#6748FE]/30 backdrop-blur-xl bg-[#030917]/60 ${
              ...
              >
                ...
                <div className="relative z-10 flex flex-col flex-1">
                  <div className="flex flex-col items-center text-center mb-4">
                    ...
                    <h3
                      className="mt-3 text-xl md:text-2xl font-extrabold tracking-tight"
                      style={{ color: "#6748FE" }}
                    >
                      {proc.name}
                    </h3>
                  ...
                  {proc.services && (
                    <div className="flex-1">
                      <span
                        className="block mb-2.5 text-xs uppercase tracking-[0.2em] font-bold"
                        style={{ color: "#6748FE" }}
                      >
                        Services
                      </span>
