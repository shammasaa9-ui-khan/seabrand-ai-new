...
// //           <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight m-0 select-none">
// //             {approachData.title}
// //           </h2>
// //         </header>
...
// //                       <h3 className="text-2xl font-bold text-white tracking-tight m-0 transition-colors duration-300 group-hover:text-sky-200">
// //                         {item.title}
// //                       </h3>
...
//         {/* Section Header - Desktop view മാറ്റമില്ലാതെ, മൊബൈൽ വ്യൂവിൽ മാത്രം letter spacing കൂട്ടിയിരിക്കുന്നു */}
//         <header className="text-center mb-16">
