...
// //         <h2 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight leading-tight m-0">
// //           {parts[0]}
// //           {parts.length > 1 && (
...
// //   return (
// //     <main className="tech-background py-20 px-4 md:px-8 min-h-screen flex flex-col items-center text-slate-100">
// //       {/* Header Section */}
// //       <div className="text-center max-w-3xl mb-16 mx-auto z-10">
// //         <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight flex items-center justify-center gap-2 flex-wrap text-white">
// //           <span>The Brain</span>
...
//       {/* 2. Subtle Marble & Fluid Veins (ചിത്രത്തിലെ അതേ ഓർഗാനിക് ലൈനുകൾ) */}
...
//       {/* 3. Vignette Shadow Edge Fade (വശങ്ങളിലെ കറുപ്പിലേക്ക് പോകുന്ന ഫേഡിംഗ്) */}
//       <div 
