...
export default function EcosystemWorkflowSplitDivs() { 
  const [activeStep, setActiveStep] = useState<number | null>(0); 
  const [isZoomed, setIsZoomed] = useState(false); // State for direct zoom toggle
      ...
      <div className="relative z-10 max-w-7xl mx-auto"> 
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start"> 
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 flex flex-col"> 
            ...
            {/* DIRECT ZOOM ON IMAGE CLICK (NO POPUP) */} 
            <div 
              onClick={() => setIsZoomed(!isZoomed)}
              className="relative aspect-[16/11] overflow-hidden rounded-xl border border-slate-200 shadow-md cursor-pointer"
            > 
              <img 
                src="/images/workflow1.png" 
                alt="Workflow" 
