...
//                   {/* Title (Mobile view letter spacing increased with tracking-[0.1em], desktop view stays clean with lg:tracking-tight) */}
//                   <div className="card-titles flex flex-col pt-2">
//                     <h3 className="card-title text-xl md:text-2xl font-bold text-white tracking-[0.1em] lg:tracking-tight group-hover:text-blue-200 transition-colors duration-300 m-0">
//                       {pillar.title}
//                     </h3>
//                   </div>
